...
try{
  ...
  $sql = "SELECT po.product_order_no, po.product_order_time, po.product_order_tp, po.order_shipping, po.mem_no, poi.product_no, poi.product_total, poi.product_order_price, p.product_name from product_order po join product_order_item poi on po.product_order_no = poi.product_order_no left join product p on p.product_no = poi.product_no where po.mem_no = :aaa ;";  //sql= : 自訂變數

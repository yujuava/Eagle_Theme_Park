...
try{
    ...
    if(copy( $from, $to)===true){
        //寫入資料庫指令
        $sql = "insert into `article` (`article_no`, `mem_no`, `article_title`, `article_date`, `article_content`, `article_image`) values (:article_title, :article_content, :article_image)";
        ...
        $post->bindValue(":article_image",$fileName);
        $post->execute();
        echo "異動成功~~";  
    }

...
try{
    ...
    //寫入資料庫指令
    $sql = "update member set mem_name = :mem_name, mem_lastname = :mem_lastname, mem_id = 'chen', mem_psw = :mem_psw, mem_tel = :mem_tel, mem_mail = :mem_mail,mem_address = :mem_adress, mem_country = :mem_country where member.mem_no = :mem_no";


    //合成sql指令,並綁訂對應值
    $members = $pdo->prepare($sql);
    $members->bindValue(":mem_id",$_GET["mem_id"]);

...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='發布文章';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='文章留言';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='優惠劵';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='客服機器人';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='管理員';
...
CREATE TABLE `facility` (
  ...
  `fac_descrip` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '設施描述',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='設施管理';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='會員';
...
CREATE TABLE `news` (
  ...
  `news_pic` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消息圖片',
  `news_name` varchar(10) NOT NULL COMMENT '消息名稱',
  `news_content` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消息內容',
  `news_date` date NOT NULL COMMENT '發布日期(order by date DESC)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='最新消息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='明信片';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='明信片封面';
...
CREATE TABLE `product` (
  ...
  `product_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品名稱',
  `product_price` int NOT NULL COMMENT '商品價格',
  `product_infor` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品資訊',
  `product_amount` int NOT NULL DEFAULT '1' COMMENT '商品預設數量',
  `product_pic` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品圖片',
...
CREATE TABLE `product_order` (
  ...
  `order_shipping` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '訂單狀態(0:未出貨、1:已出貨、2:已收貨、3:訂單完成、4:已取消)',
  `product_order_time` date DEFAULT NULL COMMENT '下訂時間',
  `product_order_way` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '取貨方式(0:宅配、1:超商取貨)',
  `product_order_place` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '取貨地點',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='商品訂單';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='商品訂單項目';
...
CREATE TABLE `ticket` (
  ...
  `ticket_name` varchar(24) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '票券種類名稱',
  `ticket_creat` date NOT NULL COMMENT '票券種類建立日期',
  `ticket_price` int NOT NULL COMMENT '票券價格'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='票券種類';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='票券訂單項目';
...
CREATE TABLE `ticket_order` (
  ...
  `ticket_order_shipping` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '票券訂單狀態(1:已出票、2:已取消)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='票券訂單';
